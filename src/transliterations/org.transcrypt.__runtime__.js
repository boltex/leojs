...
/* 000003 */ __envir__.transpiler_version = '3.7.16';
/* 000003 */ 
...
/* 000004 */ };
/* 000004 */ export var __proxy__ = false;
...
/* 000004 */             instance = new Proxy (instance, {
...
/* 000029 */ 		if (len (self.__args__) > 1) {
/* 000030 */ 			return '{}{}'.format (self.__class__.__name__, repr (tuple (self.__args__)));
/* 000030 */ 		}
/* 000031 */ 		else if (len (self.__args__)) {
/* 000032 */ 			return '{}({})'.format (self.__class__.__name__, repr (self.__args__ [0]));
/* 000032 */ 		}
/* 000033 */ 		else {
/* 000034 */ 			return '{}()'.format (self.__class__.__name__);
/* 000034 */ 		}
/* 000034 */ 	});},
/* 000036 */ 	get __str__ () {return __get__ (this, function (self) {
/* 000037 */ 		if (len (self.__args__) > 1) {
/* 000038 */ 			return str (tuple (self.__args__));
/* 000038 */ 		}
/* 000039 */ 		else if (len (self.__args__)) {
/* 000040 */ 			return str (self.__args__ [0]);
/* 000040 */ 		}
/* 000041 */ 		else {
/* 000042 */ 			return '';
/* 000042 */ 		}
/* 000042 */ 	});}
/* 000042 */ });
/* 000044 */ export var IterableError =  __class__ ('IterableError', [Exception], {
/* 000044 */ 	__module__: __name__,
/* 000045 */ 	get __init__ () {return __get__ (this, function (self, error) {
/* 000046 */ 		Exception.__init__ (self, "Can't iterate over non-iterable", __kwargtrans__ ({error: error}));
/* 000046 */ 	});}
/* 000046 */ });
/* 000048 */ export var StopIteration =  __class__ ('StopIteration', [Exception], {
/* 000048 */ 	__module__: __name__,
/* 000049 */ 	get __init__ () {return __get__ (this, function (self, error) {
/* 000050 */ 		Exception.__init__ (self, 'Iterator exhausted', __kwargtrans__ ({error: error}));
/* 000050 */ 	});}
/* 000050 */ });
/* 000052 */ export var ValueError =  __class__ ('ValueError', [Exception], {
/* 000052 */ 	__module__: __name__,
/* 000053 */ 	get __init__ () {return __get__ (this, function (self, message, error) {
/* 000054 */ 		Exception.__init__ (self, message, __kwargtrans__ ({error: error}));
/* 000054 */ 	});}
/* 000054 */ });
/* 000056 */ export var KeyError =  __class__ ('KeyError', [Exception], {
/* 000056 */ 	__module__: __name__,
/* 000057 */ 	get __init__ () {return __get__ (this, function (self, message, error) {
/* 000058 */ 		Exception.__init__ (self, message, __kwargtrans__ ({error: error}));
/* 000058 */ 	});}
/* 000058 */ });
/* 000060 */ export var AssertionError =  __class__ ('AssertionError', [Exception], {
/* 000060 */ 	__module__: __name__,
/* 000061 */ 	get __init__ () {return __get__ (this, function (self, message, error) {
/* 000062 */ 		if (message) {
/* 000063 */ 			Exception.__init__ (self, message, __kwargtrans__ ({error: error}));
/* 000063 */ 		}
/* 000064 */ 		else {
/* 000065 */ 			Exception.__init__ (self, __kwargtrans__ ({error: error}));
/* 000065 */ 		}
/* 000065 */ 	});}
/* 000065 */ });
/* 000067 */ export var NotImplementedError =  __class__ ('NotImplementedError', [Exception], {
/* 000067 */ 	__module__: __name__,
/* 000068 */ 	get __init__ () {return __get__ (this, function (self, message, error) {
/* 000069 */ 		Exception.__init__ (self, message, __kwargtrans__ ({error: error}));
/* 000069 */ 	});}
/* 000069 */ });
/* 000071 */ export var IndexError =  __class__ ('IndexError', [Exception], {
/* 000071 */ 	__module__: __name__,
/* 000072 */ 	get __init__ () {return __get__ (this, function (self, message, error) {
/* 000073 */ 		Exception.__init__ (self, message, __kwargtrans__ ({error: error}));
/* 000073 */ 	});}
/* 000073 */ });
/* 000075 */ export var AttributeError =  __class__ ('AttributeError', [Exception], {
/* 000075 */ 	__module__: __name__,
/* 000076 */ 	get __init__ () {return __get__ (this, function (self, message, error) {
/* 000077 */ 		Exception.__init__ (self, message, __kwargtrans__ ({error: error}));
/* 000077 */ 	});}
/* 000077 */ });
/* 000079 */ export var py_TypeError =  __class__ ('py_TypeError', [Exception], {
/* 000079 */ 	__module__: __name__,
/* 000080 */ 	get __init__ () {return __get__ (this, function (self, message, error) {
/* 000081 */ 		Exception.__init__ (self, message, __kwargtrans__ ({error: error}));
/* 000081 */ 	});}
/* 000081 */ });
/* 000087 */ export var Warning =  __class__ ('Warning', [Exception], {
/* 000087 */ 	__module__: __name__,
/* 000087 */ });
/* 000092 */ export var UserWarning =  __class__ ('UserWarning', [Warning], {
/* 000092 */ 	__module__: __name__,
/* 000092 */ });
/* 000095 */ export var DeprecationWarning =  __class__ ('DeprecationWarning', [Warning], {
/* 000095 */ 	__module__: __name__,
/* 000095 */ });
/* 000098 */ export var RuntimeWarning =  __class__ ('RuntimeWarning', [Warning], {
/* 000098 */ 	__module__: __name__,
/* 000098 */ });
/* 000103 */ export var __sort__ = function (iterable, key, reverse) {
/* 000103 */ 	if (typeof key == 'undefined' || (key != null && key.hasOwnProperty ("__kwargtrans__"))) {;
/* 000103 */ 		var key = null;
/* 000103 */ 	};
/* 000103 */ 	if (typeof reverse == 'undefined' || (reverse != null && reverse.hasOwnProperty ("__kwargtrans__"))) {;
/* 000103 */ 		var reverse = false;
/* 000103 */ 	};
...
/* 000103 */ 					case 'iterable': var iterable = __allkwargs0__ [__attrib0__]; break;
/* 000103 */ 					case 'key': var key = __allkwargs0__ [__attrib0__]; break;
/* 000103 */ 					case 'reverse': var reverse = __allkwargs0__ [__attrib0__]; break;
/* 000103 */ 				}
/* 000103 */ 			}
/* 000103 */ 		}
/* 000103 */ 	}
...
/* 000103 */ 	}
/* 000104 */ 	if (key) {
/* 000105 */ 		iterable.sort ((function __lambda__ (a, b) {
...
/* 000105 */ 							case 'a': var a = __allkwargs0__ [__attrib0__]; break;
/* 000105 */ 							case 'b': var b = __allkwargs0__ [__attrib0__]; break;
/* 000105 */ 						}
/* 000105 */ 					}
/* 000105 */ 				}
/* 000105 */ 			}
/* 000105 */ 			else {
/* 000105 */ 			}
/* 000105 */ 			return (key (a) > key (b) ? 1 : -(1));
/* 000105 */ 		}));
/* 000105 */ 	}
/* 000106 */ 	else {
/* 000107 */ 		iterable.sort ();
/* 000107 */ 	}
/* 000109 */ 	if (reverse) {
/* 000110 */ 		iterable.reverse ();
/* 000110 */ 	}
/* 000110 */ };
/* 000112 */ export var sorted = function (iterable, key, reverse) {
/* 000112 */ 	if (typeof key == 'undefined' || (key != null && key.hasOwnProperty ("__kwargtrans__"))) {;
/* 000112 */ 		var key = null;
/* 000112 */ 	};
/* 000112 */ 	if (typeof reverse == 'undefined' || (reverse != null && reverse.hasOwnProperty ("__kwargtrans__"))) {;
/* 000112 */ 		var reverse = false;
/* 000112 */ 	};
...
/* 000112 */ 					case 'iterable': var iterable = __allkwargs0__ [__attrib0__]; break;
/* 000112 */ 					case 'key': var key = __allkwargs0__ [__attrib0__]; break;
/* 000112 */ 					case 'reverse': var reverse = __allkwargs0__ [__attrib0__]; break;
/* 000112 */ 				}
/* 000112 */ 			}
/* 000112 */ 		}
/* 000112 */ 	}
/* 000112 */ 	else {
/* 000112 */ 	}
/* 000113 */ 	if (py_typeof (iterable) == dict) {
/* 000114 */ 		var result = copy (iterable.py_keys ());
/* 000114 */ 	}
/* 000115 */ 	else {
/* 000116 */ 		var result = copy (iterable);
/* 000116 */ 	}
/* 000118 */ 	__sort__ (result, key, reverse);
/* 000119 */ 	return result;
/* 000119 */ };
/* 000123 */ export var map = function (func, iterable) {
/* 000124 */ 	return (function () {
/* 000124 */ 		var __accu0__ = [];
/* 000124 */ 		for (var item of iterable) {
/* 000124 */ 			__accu0__.append (func (item));
/* 000124 */ 		}
/* 000124 */ 		return __accu0__;
/* 000124 */ 	}) ();
/* 000124 */ };
/* 000127 */ export var filter = function (func, iterable) {
/* 000128 */ 	if (func == null) {
/* 000129 */ 		var func = bool;
/* 000129 */ 	}
/* 000130 */ 	return (function () {
/* 000130 */ 		var __accu0__ = [];
/* 000130 */ 		for (var item of iterable) {
/* 000130 */ 			if (func (item)) {
/* 000130 */ 				__accu0__.append (item);
/* 000130 */ 			}
/* 000130 */ 		}
/* 000130 */ 		return __accu0__;
/* 000130 */ 	}) ();
/* 000130 */ };
/* 000132 */ export var divmod = function (n, d) {
/* 000133 */ 	return tuple ([Math.floor (n / d), __mod__ (n, d)]);
/* 000133 */ };
/* 000239 */ export var __Terminal__ =  __class__ ('__Terminal__', [object], {
/* 000239 */ 	__module__: __name__,
/* 000249 */ 	get __init__ () {return __get__ (this, function (self) {
/* 000250 */ 		self.buffer = '';
/* 000252 */ 		try {
/* 000253 */ 			self.element = document.getElementById ('__terminal__');
/* 000253 */ 		}
/* 000253 */ 		catch (__except0__) {
/* 000255 */ 			self.element = null;
/* 000255 */ 		}
/* 000257 */ 		if (self.element) {
/* 000258 */ 			self.element.style.overflowX = 'auto';
/* 000259 */ 			self.element.style.boxSizing = 'border-box';
/* 000260 */ 			self.element.style.padding = '5px';
/* 000261 */ 			self.element.innerHTML = '_';
/* 000261 */ 		}
/* 000263 */ 	});},
/* 000265 */ 	get print () {return __get__ (this, function (self) {
/* 000265 */ 		var sep = ' ';
/* 000265 */ 		var end = '\n';
...
/* 000265 */ 						case 'sep': var sep = __allkwargs0__ [__attrib0__]; break;
/* 000265 */ 						case 'end': var end = __allkwargs0__ [__attrib0__]; break;
/* 000265 */ 					}
/* 000265 */ 				}
/* 000265 */ 			}
/* 000265 */ 			var args = tuple ([].slice.apply (arguments).slice (1, __ilastarg0__ + 1));
/* 000265 */ 		}
/* 000265 */ 		else {
/* 000265 */ 			var args = tuple ();
/* 000265 */ 		}
/* 000266 */ 		self.buffer = '{}{}{}'.format (self.buffer, sep.join ((function () {
/* 000266 */ 			var __accu0__ = [];
/* 000266 */ 			for (var arg of args) {
/* 000266 */ 				__accu0__.append (str (arg));
/* 000266 */ 			}
/* 000266 */ 			return __accu0__;
/* 000266 */ 		}) ()), end).__getslice__ (-(4096), null, 1);
/* 000268 */ 		if (self.element) {
/* 000269 */ 			self.element.innerHTML = self.buffer.py_replace ('\n', '<br>').py_replace (' ', '&nbsp');
/* 000270 */ 			self.element.scrollTop = self.element.scrollHeight;
/* 000270 */ 		}
/* 000271 */ 		else {
/* 000272 */ 			console.log (sep.join ((function () {
/* 000272 */ 				var __accu0__ = [];
/* 000272 */ 				for (var arg of args) {
/* 000272 */ 					__accu0__.append (str (arg));
/* 000272 */ 				}
/* 000272 */ 				return __accu0__;
/* 000272 */ 			}) ()));
/* 000272 */ 		}
/* 000272 */ 	});},
/* 000274 */ 	get input () {return __get__ (this, function (self, question) {
...
/* 000274 */ 						case 'question': var question = __allkwargs0__ [__attrib0__]; break;
/* 000274 */ 					}
/* 000274 */ 				}
/* 000274 */ 			}
/* 000274 */ 		}
/* 000274 */ 		else {
/* 000274 */ 		}
/* 000275 */ 		self.print ('{}'.format (question), __kwargtrans__ ({end: ''}));
/* 000276 */ 		var answer = window.prompt ('\n'.join (self.buffer.py_split ('\n').__getslice__ (-(8), null, 1)));
/* 000277 */ 		self.print (answer);
/* 000278 */ 		return answer;
/* 000280 */ 	});}
/* 000280 */ });
/* 000282 */ export var __terminal__ = __Terminal__ ();
/* 000284 */ export var print = __terminal__.print;
/* 000285 */ export var input = __terminal__.input;
/* 000285 */ 
