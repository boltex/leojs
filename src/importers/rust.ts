#@+leo-ver=5-thin
#@+node:felix.20230505220205.141: * @file src/importers/rust.ts
...
#@+others
#@+node:felix.20230505220205.142: ** class Rust_Importer
class Rust_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.143: *3* rust_i.compute_headline
