#@+leo-ver=5-thin
#@+node:felix.20230505220205.52: * @file src/importers/leo_rst.ts
"""
...
underlines = '*=-^~"\'+!$%&(),./:;<>?@[\\]_`{|}#'
#@+others
#@+node:felix.20230505220205.53: ** class Rst_Importer(Importer)
class Rst_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.54: *3* rst_i.gen_lines & helpers
    ...
    #@+node:felix.20230505220205.55: *4* rst_i.ch_level
    ...
    #@+node:felix.20230505220205.56: *4* rst_i.is_lookahead_overline
    ...
    #@+node:felix.20230505220205.57: *4* rst_i.is_lookahead_underline
    ...
    #@+node:felix.20230505220205.58: *4* rst_i.is_underline
    def is_underline(self, line: str, extra: str = None) -> bool:
        ...
        for ch in line.rstrip():
            if ch != ch1:
                return False
        return bool(ch1)
    #@+node:felix.20230505220205.59: *4* rst_i.make_dummy_node
    def make_dummy_node(self, headline: str) -> Position:
        ...
        return child
    #@+node:felix.20230505220205.60: *4* rst_i.make_rst_node
