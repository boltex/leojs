#@+leo-ver=5-thin
#@+node:felix.20230505220205.90: * @file src/importers/lua.ts
"""
...
#@+others
#@+node:felix.20230505220205.91: ** class Lua_Importer(Importer)
class Lua_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.92: *3* lua_i.compute_headline
    def compute_headline(self, s: str) -> str:
        ...
        if i > -1:
            s = s[:i]
        return s.strip()
    #@+node:felix.20230505220205.93: *3* lua_i.gen_lines_prepass
