#@+leo-ver=5-thin
#@+node:felix.20230505220205.37: * @file src/importers/java.ts
...
#@+others
#@+node:felix.20230505220205.38: ** class Java_Importer
class Java_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.39: *3* java_i.match_start_patterns
    ...
    def match_start_patterns(self, line: str) -> bool:
        ...
        if m:
            ...
            return True
        return False
    #@+node:felix.20230505220205.40: *3* java_i.new_starts_block
