#@+leo-ver=5-thin
#@+node:felix.20230505220205.33: * @file src/importers/ini.ts
...
#@+others
#@+node:felix.20230505220205.34: ** class Ini_Importer(Importer)
class Ini_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.35: *3* ini_i.gen_lines
    ...
    #@+node:felix.20230505220205.36: *3* ini_i.starts_block
