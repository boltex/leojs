#@+leo-ver=5-thin
#@+node:felix.20230505220205.110: * @file src/importers/pascal.ts
...
#@+others
#@+node:felix.20230505220205.111: ** class Pascal_Importer
class Pascal_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.112: *3* pascal_i.compute_headline
    ...
    #@+node:felix.20230505220205.113: *3* pascal_i.gen_lines_prepass
