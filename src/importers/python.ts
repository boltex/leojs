#@+leo-ver=5-thin
#@+node:felix.20230505220205.122: * @file src/importers/python.ts
...
#@+<< define def_tuple >>
#@+node:felix.20230505220205.123: ** << define def_tuple >>
...
#@-<< define def_tuple >>
#@+others
#@+node:felix.20230505220205.124: ** class Python_Importer(Importer)
class Python_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.125: *3* python_i.compute_headline
    def compute_headline(self, s: str) -> str:
        ...
        return s.strip()
    #@+node:felix.20230505220205.126: *3* python_i.declaration_headline
    ...
    #@+node:felix.20230505220205.127: *3* python_i.get_block
    ...
    #@+node:felix.20230505220205.128: *3* python_i.is_intro_line
    ...
    #@+node:felix.20230505220205.129: *3* python_i.new_starts_block
    ...
    def new_starts_block(self, i: int) -> Optional[int]:
        ...
        return i + newlines + 1
    #@-others
#@+node:felix.20230505220205.130: ** function: token_based_python_importer
...
def token_based_python_importer(c: Cmdr, root: Position, s: str) -> None:
    ...
    #@+others
    #@+node:felix.20230505220205.131: *3* function: getdefn & helper
    ...
    #@+node:felix.20230505220205.132: *4* function: get_intro (Vitalije's importer)
    def get_intro(row: int, col: int) -> int:
        ...
        for i in range(last, row):
            if lines[i - 1].isspace():
                last = i + 1
        return row - last
    #@+node:felix.20230505220205.133: *4* function: is_intro_line (Vitalije's importer)
    def is_intro_line(n: int, col: int) -> bool:
        ...
        if t.type == token.COMMENT:
            ...
            return True
        return False
    #@+node:felix.20230505220205.134: *3* mknode & helpers
    def mknode(
    ...
    #@+node:felix.20230505220205.135: *4* body & bodyLine
    ...
    #@+node:felix.20230505220205.136: *4* declaration_headline
    ...
    #@+node:felix.20230505220205.137: *3* utils
    #@+node:felix.20230505220205.138: *4* find_token
    ...
    #@+node:felix.20230505220205.139: *4* itoks
    def itoks(i: int) -> Generator:
        ...
        while i < len(rawtokens):
            yield(i, rawtokens[i])
            i += 1
    #@+node:felix.20230505220205.140: *4* mkreadline
