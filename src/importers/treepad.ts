#@+leo-ver=5-thin
#@+node:felix.20230505220205.148: * @file src/importers/treepad.ts
...
#@+others
#@+node:felix.20230505220205.149: ** class Treepad_Importer(Importer)
class Treepad_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.150: *3* treepad_i.gen_lines
