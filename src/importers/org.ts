#@+leo-ver=5-thin
#@+node:felix.20230505220205.102: * @file src/importers/org.ts
...
#@+others
#@+node:felix.20230505220205.103: ** class Org_Importer(Importer)
class Org_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.104: *3* org_i.gen_lines
    ...
    #@+node:felix.20230505220205.105: *3* org_i.add_headline_tags
