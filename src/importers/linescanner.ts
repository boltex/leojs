#@+leo-ver=5-thin
#@+node:felix.20230505220205.61: * @file src/importers/linescanner.ts
...
#@+<< define block_tuple >>
#@+node:felix.20230505220205.62: ** << define block_tuple >>
...
#@-<< define block_tuple >>
#@+others
#@+node:felix.20230505220205.63: ** class NewScanState
class NewScanState:
    ...
    __str__ = __repr__
#@+node:felix.20230505220205.64: ** class Importer
class Importer:
    """
    ...
    #@+others
    #@+node:felix.20230505220205.65: *3* i.__init__ & reloadSettings
    def __init__(self,
        c: Cmdr,
    ...
    #@+node:felix.20230505220205.66: *3* i.import_from_string (driver) & helpers
    def import_from_string(self, parent: Position, s: str) -> None:
        ...
        for p in root.self_and_subtree():
            p.clearDirty()
    #@+node:felix.20230505220205.67: *4* i.preprocess_lines
    def preprocess_lines(self, lines: List[str]) -> List[str]:
        ...
        """
        return lines
    #@+node:felix.20230505220205.68: *4* i.regularize_whitespace
    def regularize_whitespace(self, lines: List[str]) -> List[str]:  # pragma: no cover (missing test)
        ...
        return result
    #@+node:felix.20230505220205.69: *4* i.check_blanks_and_tabs
    def check_blanks_and_tabs(self, lines: List[str]) -> bool:  # pragma: no cover (missing test)
        ...
        if not ok:
            if g.unitTesting:
                ...
                g.es(message)
        return ok
    #@+node:felix.20230505220205.70: *4* i.gen_lines & helpers (trace)
    ...
    #@+node:felix.20230505220205.71: *5* i.append_directives
    ...
    #@+node:felix.20230505220205.72: *5* i.body_string
    ...
    #@+node:felix.20230505220205.73: *5* i.compute_headline
    def compute_headline(self, s: str) -> str:
        ...
        for ch in '{(=;':
            ...
            if i > -1:
                s = s[:i]
        return s.strip()
    #@+node:felix.20230505220205.74: *5* i.create_placeholders
    def create_placeholders(self, level: int, lines_dict: Dict, parents: List[Position]) -> None:
        ...
        while n > 0:
            ...
            lines_dict[child.v] = []
    #@+node:felix.20230505220205.75: *5* i.declaration_headline
    ...
    #@+node:felix.20230505220205.76: *5* i.gen_lines_prepass
    def gen_lines_prepass(self) -> None:
        """A hook for pascal and lua. Called by i.gen_lines()."""
        pass
    #@+node:felix.20230505220205.77: *5* i.get_block
    ...
    #@+node:felix.20230505220205.78: *5* i.get_intro
    ...
    #@+node:felix.20230505220205.79: *5* i.is_intro_line
    ...
    #@+node:felix.20230505220205.80: *5* i.make_node (trace)
    def make_node(self,
    ...
    #@+node:felix.20230505220205.81: *5* i.new_skip_block (trace)
    ...
    #@+node:felix.20230505220205.82: *5* i.new_starts_block
    def new_starts_block(self, i: int) -> Optional[int]:
        ...
        if this_state.level > prev_state.level:
            return i + 1
        return None
    #@+node:felix.20230505220205.83: *3* i.scan_all_lines & helper
    def scan_all_lines(self) -> List["NewScanState"]:
        ...
        return states
    #@+node:felix.20230505220205.84: *4* i.scan_one_line & helper
    ...
    #@+node:felix.20230505220205.85: *5* i.update_level
    def update_level(self, i: int, level: int, line: str) -> Tuple[int, int]:
        ...
        i += 1
        return i, level
    #@+node:felix.20230505220205.86: *3* i: Messages
    ...
    def warning(self, s: str) -> None:  # pragma: no cover
        if not g.unitTesting:
            g.warning('Warning:', s)
    #@+node:felix.20230505220205.87: *3* i: Whitespace
    #@+node:felix.20230505220205.88: *4* i.get_int_lws
    ...
    #@+node:felix.20230505220205.89: *4* i.get_str_lws
