#@+leo-ver=5-thin
#@+node:felix.20230505220205.17: * @file src/importers/ctext.ts
import re
...
#@+others
#@+node:felix.20230505220205.18: ** class CText_Importer
class CText_Importer(Importer):
    #@+<< ctext docstring >>
    #@+node:felix.20230505220205.19: *3* << ctext docstring >>
    """
    ...
    #@+others
    #@+node:felix.20230505220205.20: *3* ctext_i.import_from_string
