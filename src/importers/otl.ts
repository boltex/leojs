#@+leo-ver=5-thin
#@+node:felix.20230505220205.106: * @file src/importers/otl.ts
...
#@+others
#@+node:felix.20230505220205.107: ** class Otl_Importer(Importer)
class Otl_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.108: *3* otl_i.gen_lines
    ...
    #@+node:felix.20230505220205.109: *3* otl.regularize_whitespace
