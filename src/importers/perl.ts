#@+leo-ver=5-thin
#@+node:felix.20230505220205.114: * @file src/importers/perl.ts
...
#@+others
#@+node:felix.20230505220205.115: ** class Perl_Importer
class Perl_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.116: *3* perl_i.compute_headline
