#@+leo-ver=5-thin
#@+node:felix.20230505220205.3: * @file src/importers/c.ts
...
#@+others
#@+node:felix.20230505220205.4: ** class C_Importer
class C_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.5: *3* c_i.ctor
    ...
    #@+node:felix.20230505220205.6: *3* c_i.new_starts_block & helper
    ...
    #@+node:felix.20230505220205.7: *4* c_i.match_start_patterns
