#@+leo-ver=5-thin
#@+node:felix.20230505220205.21: * @file src/importers/cython.ts
...
#@+others
#@+node:felix.20230505220205.22: ** class Cython_Importer(Python_Importer)
class Cython_Importer(Python_Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.23: *3* cython_i.new_starts_block
