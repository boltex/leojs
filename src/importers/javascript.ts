#@+leo-ver=5-thin
#@+node:felix.20230505220205.41: * @file src/importers/javascript.ts
...
#@+others
#@+node:felix.20230505220205.42: ** class JS_Importer
class JS_Importer(Importer):
    ...
    #@+others
    #@+node:felix.20230505220205.43: *3* js_i.compute_headline
    clean_regex_list1 = [
        # (function name (
    ...
    #@-others
#@+node:felix.20230505220205.44: ** JsLexer...
...
#@+node:felix.20230505220205.45: *3* class Tok
class Tok:
    ...
    def __init__(self, name: str, regex: str, next: str = None) -> None:
        ...
        self.regex = regex
        self.next = next
#@+node:felix.20230505220205.46: *3* class Lexer
class Lexer:
    """A generic multi-state regex-based lexer."""

    #@+others
    #@+node:felix.20230505220205.47: *4* Lexer.__init__
    def __init__(self, states: Dict, first: Any) -> None:
        ...
        self.state = first
    #@+node:felix.20230505220205.48: *4* Lexer.lex
    def lex(self, text: str) -> Generator:
        ...
        self.state = state
    #@-others
#@+node:felix.20230505220205.49: *3* function: literals
...
#@+node:felix.20230505220205.50: *3* class JsLexer(Lexer)
class JsLexer(Lexer):
    """A Javascript lexer
    ...
    #@+<< constants >>
    #@+node:felix.20230505220205.51: *4* << constants >> (JsLexer)
