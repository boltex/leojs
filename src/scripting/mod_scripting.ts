//@+leo-ver=5-thin
//@+node:felix.20230924005539.1: * @file src/scripting/mod_scripting.ts
//@+<< mod_scripting docstring >>
//@+node:felix.20230924005539.2: ** << mod_scripting docstring >>
/*
...
//@+node:felix.20230924005539.3: ** << mod_scripting imports & annotations >>
...
//@+others
//@+node:felix.20230924005539.4: ** cmd decorator
/**
...
//@+node:felix.20230924005539.5: ** Top level (mod_scripting)
//@+node:felix.20230924005539.6: *3* build_rclick_tree (mod_scripting.py)
def build_rclick_tree(command_p: Position, rclicks: list[Any]=None, top_level: bool=False) -> list:
    ...
    if top_level:
        ...
        for child in command_p.children():
            ...
            build_rclick_tree(rc.position, rc.children, top_level=False)
    return rclicks
//@+node:felix.20230924005539.7: *3* init
def init() -> bool:
    ...
    return ok
//@+node:felix.20230924005539.8: *3* onCreate
...
//@+node:felix.20230924005539.9: ** class AtButtonCallback
class AtButtonCallback:
    """A class whose __call__ method is a callback for @button nodes."""
    //@+others
    //@+node:felix.20230924005539.10: *3* __init__ (AtButtonCallback)
    def __init__(self,
        controller: Any,
        b: Any,
        c: Cmdr,
    ...
    //@+node:felix.20230924005539.14: *3* AtButtonCallback.execute_script & helper
    ...
    //@+node:felix.20230924005539.15: *4* AtButtonCallback.find_script
    def find_script(self) -> str:
        ...
        return self.script
    //@-others
//@+node:felix.20230924005539.16: ** class ScriptingController
class ScriptingController:
    """A class defining scripting commands."""
    //@+others
    //@+node:felix.20230924005539.17: *3*  sc.ctor
    ...
    //@+node:felix.20230924005539.18: *3* sc.Callbacks
    //@+node:felix.20230924005539.19: *4* sc.addScriptButtonCommand
    def addScriptButtonCommand(self, event: Event=None) -> None:
        ...
        c.bodyWantsFocus()
    //@+node:felix.20230924005539.20: *4* sc.runDebugScriptCommand
    def runDebugScriptCommand(self, event: Event=None) -> None:
        ...
        if script:
            ...
            //@+node:felix.20230924005539.21: *5* << set debugging if debugger is active >>
            ...
            if debugging:
                ...
                //@+node:felix.20230924005539.22: *5* << create leoScriptModule >> (mod_scripting.py)
        ...
        c.bodyWantsFocus()
    //@+node:felix.20230924005539.23: *4* sc.runScriptCommand
    def runScriptCommand(self, event: Event=None) -> None:
        ...
        if 0:
            ...
            c.bodyWantsFocus()
    //@+node:felix.20230924005539.24: *3* sc.createAllButtons
        ...
        while p:
            ...
            if p.isAtIgnoreNode():
                ...
                if m:
                    ...
                    func(p)
                p.moveToThreadNext()
    //@+node:felix.20230924005539.25: *3* sc.createLocalAtButtonHelper
    def createLocalAtButtonHelper(
        ...
        self.registerAllCommands(
            ...
            tag='local @button')
        return b
    //@+node:felix.20230924005539.26: *3* sc.createIconButton (creates all buttons)
    def createIconButton(self,
        ...
        return b
    //@+node:felix.20230924005539.27: *3* sc.executeScriptFromButton
    def executeScriptFromButton(self,
        ...
        # Do *not* set focus here: the script may have changed the focus.
            # c.bodyWantsFocus()
    //@+node:felix.20230924005539.28: *3* sc.open_gnx
    ...
    //@+node:felix.20230924005539.29: *3* sc.Scripts, common
    # Important: common @button and @command nodes do **not** update dynamically!
    //@+node:felix.20230924005539.30: *4* sc.createCommonButtons
    ...
    //@+node:felix.20230924005539.31: *4* sc.createCommonButton (common @button)
    def createCommonButton(self, p: Position, script: str, rclicks: list[Any]=None) -> None:
        ...
        self.registerAllCommands(
            ...
            source_c=p.v.context,
            tag='@button')
    //@+node:felix.20230924005539.32: *4* sc.createCommonCommands
    ...
    //@+node:felix.20230924005539.33: *4* sc.createCommonCommand (common @command)
    ...
    //@+node:felix.20230924005539.34: *3* sc.Scripts, individual
    //@+node:felix.20230924005539.35: *4* sc.handleAtButtonNode @button
    ...
    //@+node:felix.20230924005539.36: *4* sc.handleAtCommandNode @command
    ...
    //@+node:felix.20230924005539.37: *4* sc.handleAtPluginNode @plugin
    ...
    //@+node:felix.20230924005539.38: *4* sc.handleAtRclickNode @rclick
    def handleAtRclickNode(self, p: Position) -> None:
        ...
        if p.b.strip():
            self.registerAllCommands(
                ...
                tag='local @rclick')
        g.app.config.atLocalCommandsList.append(p.copy())
    //@+node:felix.20230924005539.39: *4* sc.handleRclicks
    ...
    //@+node:felix.20230924005539.40: *4* sc.handleAtScriptNode @script
    def handleAtScriptNode(self, p: Position) -> None:
        ...
        if 0:
            # Do not assume the script will want to remain in this commander.
            c.bodyWantsFocus()
    //@+node:felix.20230924005539.41: *3* sc.Standard buttons
    //@+node:felix.20230924005539.42: *4* sc.createDebugIconButton 'debug-script'
    def createDebugIconButton(self) -> None:
        ...
        self.createIconButton(
            ...
            kind='debug-script')
    //@+node:felix.20230924005539.43: *4* sc.createRunScriptIconButton 'run-script'
    ...
    //@+node:felix.20230924005539.44: *4* sc.createScriptButtonIconButton 'script-button'
    ...
    //@+node:felix.20230924005539.45: *3* sc.Utils
    //@+node:felix.20230924005539.46: *4* sc.cleanButtonText
    def cleanButtonText(self, s: str, minimal: bool=False) -> str:
        ...
        for tag in ('@key', '@args', '@color',):
            ...
            if i > -1:
                ...
                s = s.strip()
        return s.replace(' ', '-').strip('-')
    //@+node:felix.20230924005539.47: *4* sc.createBalloon (gui-dependent)
    ...
    //@+node:felix.20230924005539.48: *4* sc.deleteButton
    ...
    //@+node:felix.20230924005539.49: *4* sc.getArgs
    def getArgs(self, p: Position) -> list[str]:
        ...
        return args
    //@+node:felix.20230924005539.50: *4* sc.getButtonText
    def getButtonText(self, h: str) -> str:
        ...
        return buttonText
    //@+node:felix.20230924005539.51: *4* sc.getColor
    def getColor(self, h: str) -> str:
        ...
        if i > -1:
            ...
            color = h[j:k].strip()
        return color
    //@+node:felix.20230924005539.52: *4* sc.getShortcut
    def getShortcut(self, h: str) -> str:
        ...
        return shortcut
    //@+node:felix.20230924005539.53: *4* sc.getScript
    ...
    //@+node:felix.20230924005539.54: *4* sc.registerAllCommands
    ...
    //@+node:felix.20230924005539.55: *4* sc.setButtonColor
    ...
    //@+node:felix.20230924005539.56: *4* sc.truncateButtonText
...
//@+node:felix.20230924005539.57: ** class EvalController
class EvalController:
    """A class defining all eval-* commands."""
    //@+others
    //@+node:felix.20230924005539.58: *3* eval.Birth
    ...
    //@+node:felix.20230924005539.59: *3* eval.Commands
    //@+node:felix.20230924005539.60: *4* eval
    @eval_cmd("eval")
    def eval_command(self, event: Event) -> None:
        //@+<< eval docstring >>
        //@+node:felix.20230924005539.61: *5* << eval docstring >>
        """
        ...
        if c == event.get('c'):
            ...
            self.eval_text(s)
    //@+node:felix.20230924005539.62: *4* eval-block
    @eval_cmd("eval-block")
    def eval_block(self, event: Event) -> None:
        //@+<< eval-block docstring >>
        //@+node:felix.20230924005539.63: *5* << eval-block docstring >>
        """
        ...
        c.redraw()
        c.bodyWantsFocusNow()
    //@+node:felix.20230924005539.64: *4* eval-last
    @eval_cmd("eval-last")
    def eval_last(self, event: Event, text: str=None) -> None:
        ...
        c.setChanged()
    //@+node:felix.20230924005539.65: *4* eval-last-pretty
    ...
    //@+node:felix.20230924005539.66: *4* eval-replace
    ...
    def eval_replace(self, event: Event) -> None:
        ...
        c.setChanged()
    //@+node:felix.20230924005539.67: *3* eval.Helpers
    //@+node:felix.20230924005539.68: *4* eval.eval_text & helpers
    def eval_text(self, s: str) -> Optional[str]:
        ...
        self.unredirect()
        return None
    //@+node:felix.20230924005539.69: *5* eval.new_exec
    def new_exec(self, s: str) -> None:
        try:
            ...
            g.es_exception()
    //@+node:felix.20230924005539.70: *5* eval.old_exec
        ...
        if not all_done:  # last block still needs using
            try:
                ...
                try:
                    ...
                    g.es_exception()
        return ans
    //@+node:felix.20230924005539.71: *5* eval.redirect & unredirect
    ...
    def unredirect(self) -> None:
        ...
        if c.config.getBool('eval-redirect'):
            ...
            if not self.old_stdout:
                g.restoreStdout()
    //@+node:felix.20230924005539.72: *5* eval.show_answers
    def show_answers(self) -> None:
        ...
        for answer in self.answers:
            key, val = answer
            g.es(f"{key} = {val}")
    //@+node:felix.20230924005539.73: *5* eval.show_legacy_answer
    def show_legacy_answer(self, ans: str, blocks: list[str]) -> str:
        ...
        if ans is not None:
            ...
            g.es(txt)
        return ans
    //@+node:felix.20230924005539.74: *4* eval.exec_then_eval (not used yet)
    def exec_then_eval(self, code: str, ns: dict) -> str:
        ...
        exec(compile(block, '<string>', mode='exec'), ns)
        return ""
    //@+node:felix.20230924005539.75: *4* eval.get_blocks
    ...
    //@+node:felix.20230924005539.76: *4* eval.get_selected_lines
