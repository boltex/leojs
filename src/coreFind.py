#@+leo-ver=5-thin
#@+node:ekr.20210102145531.1: * @file src/coreFind.py
...
#@+others
#@+node:ekr.20210102145531.7: ** class LeoFind (LeoFind.py)
class LeoFind:
    ...
    #@+node:ekr.20210102145531.10: *4* LeoFind.cmd (decorator)
    def cmd(name):
    ...
    #@+node:ekr.20210102145531.13: *3* LeoFind.Buttons (immediate execution)
    #@+node:ekr.20210102145531.14: *4* find.changeAllButton
    def changeAllButton(self, event=None):
        ...
        self.changeAll()
    #@+node:ekr.20210102145531.15: *4* find.changeButton
    def changeButton(self, event=None):
        """Handle Change button."""
        self.setup_button()
        self.change()
    #@+node:ekr.20210102145531.16: *4* find.changeThenFindButton
    def changeThenFindButton(self, event=None):
        """Handle Change, Then Find button."""
        self.setup_button()
        self.changeThenFind()
    #@+node:ekr.20210102145531.17: *4* find.findAllButton
    def findAllButton(self, event=None):
        """Handle Find All button."""
        self.setup_button()
        self.findAll()
    #@+node:ekr.20210102145531.18: *4* find.findButton (headline hack)
    def findButton(self, event=None):
        ...
        if not self.findNext() and p0 != c.p:
            ...
            c.selectPosition(p0)
            c.redraw()
    #@+node:ekr.20210102145531.19: *4* find.findPreviousButton (headline hack)
    def findPreviousButton(self, event=None):
        ...
        try:
            ...
            self.reverse = False
    #@+node:ekr.20210102145531.20: *4* find.setup_button
    def setup_button(self):
        ...
        if 0:  # We _must_ retain the editing status for incremental searches!
            c.endEditing()
        self.update_ivars()
    #@+node:ekr.20210102145531.21: *3* LeoFind.Commands (immediate execution)
    #@+node:ekr.20210102145531.22: *4* find.changeCommand
    ...
    #@+node:ekr.20210102145531.38: *4* find.hideFindTab
    @cmd('find-tab-hide')
    ...
    #@+node:ekr.20210102145531.39: *4* find.openFindTab
    @cmd('find-tab-open')
    ...
    def startSearch(self, event):
        ...
        if self.minibuffer_mode:
            ...
            self.ftm.init_focus()
    #@+node:ekr.20210102145531.44: *4* find.returnToOrigin
    ...
    #@+node:ekr.20210102145531.45: *3* LeoFind.ISearch
    #@+node:ekr.20210102145531.46: *4* find.isearchForward
    @cmd('isearch-forward')
    ...
    #@+node:ekr.20210102145531.47: *4* find.isearchBackward
    ...
    #@+node:ekr.20210102145531.48: *4* find.isearchForwardRegexp
    ...
    #@+node:ekr.20210102145531.49: *4* find.isearchBackwardRegexp
    ...
    #@+node:ekr.20210102145531.50: *4* find.isearchWithPresentOptions
    ...
    #@+node:ekr.20210102145531.51: *3* LeoFind.Isearch utils
    #@+node:ekr.20210102145531.52: *4* find.abortSearch (incremental)
    ...
    #@+node:ekr.20210102145531.53: *4* find.endSearch
    def endSearch(self):
        c, k = self.c, self.k
        k.clearState()
        k.resetLabel()
        c.bodyWantsFocus()
    #@+node:ekr.20210102145531.54: *4* find.iSearch
    def iSearch(self, again=False):
        ...
        if pos is not None:  # success.
            ...
            if not again:
                ...
                k.updateLabel(event)
    #@+node:ekr.20210102145531.55: *4* find.iSearchStateHandler
    def iSearchStateHandler(self, event):
        ...
        # Fix bug 1267921: isearch-forward accepts non-alphanumeric keys as input.
            ...
            k.updateLabel(event)
            self.iSearch()
    #@+node:ekr.20210102145531.56: *4* find.iSearchBackspace
    ...
    #@+node:ekr.20210102145531.59: *4* find.setWidget
    def setWidget(self):
        ...
        if w == wrapper:
            c.bodyWantsFocus()
        return w
    #@+node:ekr.20210102145531.60: *4* find.startIncremental
    ...
    #@+node:ekr.20210102145531.61: *3* LeoFind.Minibuffer commands
    ...
    def minibufferCloneFindAllFlattened1(self, event):
        ...
        c.treeWantsFocus()
    #@+node:ekr.20210102145531.64: *4* find.minibufferCloneFindTag
    @cmd('clone-find-tag')
    @cmd('find-clone-tag')
    @cmd('cft')
    ...
    def editWidget(self, event, forceFocus=True):
        ...
        return self.w
    #@+node:ekr.20210102145531.74: *4* find.generalChangeHelper
    ...
    #@+node:ekr.20210102145531.75: *4* find.generalSearchHelper
    ...
    def search1(self, event):
        ...
        if k.getArgEscapeFlag:
            ...
            self.lastStateHelper()
            self.generalSearchHelper(k.arg)
    #@+node:ekr.20210102145531.79: *4* find.setReplaceString
    ...
    def wordSearch1(self, event):
        ...
        self.lastStateHelper()
        self.generalSearchHelper(k.arg)
    #@+node:ekr.20210102145531.86: *3* LeoFind.Option commands
    #@+node:ekr.20210102145531.87: *4* LeoFind.toggle-find-*-option commands
    ...
    #@+node:ekr.20210102145531.88: *4* LeoFind.set-find-* commands
    ...
    def setFindScope(self, where):
        ...
        options = fc.computeFindOptionsInStatusArea()
        c.frame.statusLine.put(options)
    #@+node:ekr.20210102145531.89: *4* LeoFind.showFindOptions & helper
    ...
    #@+node:ekr.20210102145531.90: *5* LeoFind.computeFindOptions
    def computeFindOptions(self):
        ...
        part2 = ' '.join(z)
        return part1, part2
    #@+node:ekr.20210102145531.91: *4* LeoFind.setupChangePattern
    def setupChangePattern(self, pattern):
        self.ftm.setChangeText(pattern)
    #@+node:ekr.20210102145531.92: *4* LeoFind.setupSearchPattern
    def setupSearchPattern(self, pattern):
        self.ftm.setFindText(pattern)
    #@+node:ekr.20210102145531.93: *3* LeoFind.Utils
    ...
    #@+node:ekr.20210102145531.103: *4* find.cloneFindTag & helpers
    ...
    #@+node:ekr.20210102145531.136: *3* LeoFind.Initing & finalizing
